...
export default component$(
  ({
    ...
    return (
      <div
        // id={modalId}
        class="fixed left-0 right-0 top-0 z-50 h-[calc(100%-1rem)] max-h-full w-full items-center justify-center overflow-y-auto overflow-x-hidden bg-gray-900 bg-opacity-70 md:inset-0"
      >
